...
#   kernelspec:
#     display_name: Python 3.8.13 ('hela_data')
#     language: python
#     name: python3
# ---
...
from hela_data.pandas import length
from hela_data.io.mq import FASTA_KEYS, MaxQuantOutput
from hela_data.io import search_subfolders
import hela_data.io.mq as mq
from hela_data.io.mq import mq_col
...
peptide_view = (peptide_view[
    hela_data.pandas.get_unique_non_unique_columns(peptide_view).non_unique]
...
# %%
# same code fails in `hela_data.io.mq`, ABC needed?
