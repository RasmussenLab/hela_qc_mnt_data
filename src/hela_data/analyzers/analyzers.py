...
import hela_data
from hela_data.analyzers import Analysis

from hela_data.pandas import _add_indices
from hela_data.analyzers import long_format, wide_format
...
class LatentAnalysis(Analysis):
    ...
    def _plot(self, fct, meta_key: str, save: bool = True):
        ...
        if save:
            hela_data.plotting.savefig(fig, name=f'{self.model_name}_latent_by_{meta_key}',
                                       folder=self.folder)
        return fig, ax
